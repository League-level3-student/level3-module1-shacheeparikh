...
public class _03_MurderOfCrows {
	...
	private void findTheDiamond() {
		...
		for (int i = 0; i < theMurder.size(); i++) {
			ArrayList<String> searchStomach = theMurder.get(i).getStomachContents();
			System.out.println(searchStomach);
			if (searchStomach.contains("diamond")) {
				System.out.println("the crow with the diamond is  " + theMurder.get(i).getName());
			}
		}
		/*
